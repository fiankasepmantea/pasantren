        ...
        [
          _c(
            ...
            [
              _c(
                "b-card",
                { attrs: { title: "Penjualan Marketing" } },
                [
                  _c("hr"),
                  _vm._v(" "),
                  _vm._l(_vm.marketings, function(marketing, index) {
                    return _c(
                      "div",
                      {
                        key: index,
                      ...
                      [
                        _c("b-card-text", { staticClass: "card-text" }, [
                          _vm._v(_vm._s(marketing.name))
                        ]),
                        _vm._v(" "),
                        _c("b-card-text", { staticClass: "card-text" }, [
                          _vm._v("Rp. " + _vm._s(marketing.revenue))
                        ])
                      ],
                      1
                    )
          ...
          _c(
            ...
            [
              _c(
                "b-card",
                { attrs: { title: "Pendapatan" } },
                [
                  _c("b-card-text", { staticClass: "card-text" }, [
                    _vm._v("01 Agustus - 30 September")
                  ]),
                  _vm._v(" "),
                  _c("h4", { staticClass: "d-flex justify-content-end" }, [
